...
// will also cause the subscription to stop, but `Unsubscribe` must still be called.
//
// Deprecated: Use SubscribeWithArgs instead. This function will be removed in v0.8.1.
...
// will also cause the subscription to stop, but `Unsubscribe` must still be called.
//
// Deprecated: Use ChanSubscribeWithArgs instead. This function will be removed in v0.8.1.
...
// Deprecated: Use AddNodesWithArgs instead. This function will be removed in v0.8.1.
